...
- README / サンプルコード / `integration-experience.md` 内の Clip-centric 記述を浸透
- 「Clip は鳴り方を持つ／Source は鳴らすだけ」を冒頭で明示
- 移行ガイドを別ページに切り出す
...
| **IP-4 Clip-centric 再設計** | **PR-A / PR-B 完了 / PR-C1 進行中** | #33 (PR-A), #35 (PR-B), 進行中 (PR-C1) |
